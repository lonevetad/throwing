...
function boom(pos, def)
	...
	local drops, radius = tnt_explode2(pos, def.radius, def.ignore_protection,
			def.ignore_on_blast)
	-- append entity drops
...
THROWING_ARROW_ENTITY.on_step = function(self, dtime)
	...
	if self.lastpos.x~=nil then
		if node.name ~= "air" and node.name ~= "throwing:light" then
			...
			-- DO EXPLOSION !
			--print("explosions")
			--minetest.log("tnt_arrow explosions at ".. minetest.pos_to_string(pos))

			--tnt.
			tnt_explode(pos, 2, nil, nil)
			--minetest.log("tnt_arrow explosed at ".. minetest.pos_to_string(pos))
...
minetest.register_craft({
	output = 'throwing:arrow_tnt 4',
	--type = "shapeless",
	recipe = {
		{'throwing:arrow', 'default:stick', 'tnt:boom'},
	},
})

minetest.register_craft({
	output = 'throwing:arrow_tnt 2',
	--type = "shapeless",
	recipe = {
		{'throwing:arrow', 'default:stick', 'tnt:gunpowder'},
	},
})
...
minetest.register_craft({
	...
	--type = "shapeless",
	recipe = {
		{'throwing:arrow', 'default:stick', 'group:coal'},
	},
})
...
minetest.register_craft({
	...
	--type = "shapeless",
	recipe = {
		{'throwing:arrow_stone', 'default:stick', 'tnt:boom'},
	},
})
...
minetest.register_craft({
	...
	--type = "shapeless",
	recipe = {
		{'throwing:arrow_stone', 'default:stick', 'tnt:gunpowder'},
	},
})
...
minetest.register_craft({
	...
	--type = "shapeless",
	recipe = {
		{'throwing:arrow_stone', 'default:stick', 'group:coal'},
	},
})
